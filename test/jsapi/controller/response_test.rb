  ...
  module Controller
    class ResponseTest < Minitest::Test
      ...
      def test_serializes_a_boolean
        ...
        response = Response.new(true, response_model, api_definitions)
        assert_equal('true', response.to_json)
      end

      def test_serializes_an_integer
        response_model = Meta::Response.new(type: 'integer')
        response = Response.new(1.0, response_model, api_definitions)
      ...
      def test_serializes_a_number
        ...
        response = Response.new(1, response_model, api_definitions)
      ...
      def test_serializes_a_date_formatted_string
        response_model = Meta::Response.new(type: 'string', format: 'date')
        response = Response.new('2099-12-31T23:59:59+00:00', response_model, api_definitions)
        assert_equal('"2099-12-31"', response.to_json)
      end

      def test_serializes_a_datetime_formatted_string
        response_model = Meta::Response.new(type: 'string', format: 'date-time')
        response = Response.new('2099-12-31', response_model, api_definitions)
      ...
      def test_serializes_an_array
        ...
        response = Response.new(%w[Foo Bar], response_model, api_definitions)
      ...
      def test_serializes_an_empty_array
        response_model = Meta::Response.new(type: 'array', items: { type: 'string' })
        response = Response.new([], response_model, api_definitions)
      ...
      def test_serializes_a_nullable_array
        response_model = Meta::Response.new(type: 'array', items: { type: 'string' })
        response = Response.new(nil, response_model, api_definitions)
      ...
      def test_raises_error_on_invalid_response
        ...
        error = assert_raises RuntimeError do
          Response.new(nil, response_model, api_definitions).to_json
        end
      ...
      def test_raises_error_on_invalid_object
        ...
        error = assert_raises RuntimeError do
          Response.new(object, response_model, api_definitions).to_json
        end
