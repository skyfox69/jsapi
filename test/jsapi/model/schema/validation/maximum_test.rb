    ...
    module Schema
      module Validation
        class MaximumTest < Minitest::Test
          ...
          def test_positive_maximum_validation
            maximum = Maximum.new(0)
            dummy = Dummy.new(0)

            maximum.validate(dummy)
          ...
          def test_positive_exclusive_maximum_validation
            exclusive_maximum = Maximum.new(0, exclusive: true)
            dummy = Dummy.new(-1)

            exclusive_maximum.validate(dummy)
            assert_predicate(dummy.errors, :none?)
          end

          def test_negative_exclusive_maximum_validation
            exclusive_maximum = Maximum.new(0, exclusive: true)
            dummy = Dummy.new(0)
          ...
          def test_json_schema_maximum_validation
            assert_equal(
              { maximum: 0 },
          ...
          def test_json_schema_exclusive_maximum_validation
            assert_equal(
              { exclusiveMaximum: 0 },
          ...
          def test_openapi_3_0_maximum_validation
            assert_equal(
              { maximum: 0 },
          ...
          def test_openapi_3_0_exclusive_maximum_validation
            assert_equal(
              {
                maximum: 0,
          ...
          def test_openapi_3_1_maximum_validation
            assert_equal(
              { maximum: 0 },
          ...
          def test_openapi_3_1_exclusive_maximum_validation
            assert_equal(
              { exclusiveMaximum: 0 },
